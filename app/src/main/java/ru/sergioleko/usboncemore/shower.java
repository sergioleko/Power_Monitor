    ...
    public void startReader() {
       ...
       // TextView text = findViewById(R.id.showerText);
        ...
        if (usbmanager != null) {
            ...
            float[] maxValues = new float[]{60.0f, 2.51f, 1.91f, 1.31f, 1.11f, 40.0f, 40.0f, 4.61f, 1.91f, 1.11f, 3.41f, 1.61f, 12.11f, 40.0f, 40.0f};
            float[] minvalues = new float[]{0.0f, 2.29f, 1.69f, 1.09f, 0.89f, 0.0f, 0.0f, 4.39f, 1.69f, 0.89f, 3.19f, 1.39f, 1.9f, 0.0f, 0.0f};
